    ...
    <section className="py-28 bg-volunteer-bg bg-no-repeat bg-cover">
      <div className="container mx-auto lg:max-w-screen-xl px-4">
        <div className="text-center">
          <h2 className="text-30 font-medium text-white mb-6">Become a Volunteer</h2>
          <p className="text-16 text-white lg:max-w-60% mx-auto mb-6">
            Lorem ipsum dolor sit amet, consectetur adipiscelit. Nam malesu dolor sit amet,
            consectetur adipiscelit. consectetur adipiscelit. Nam malesu dolor.
          </p>
